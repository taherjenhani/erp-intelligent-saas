...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('REGISTER', 'LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGOUT', 'REFRESH_TOKEN', 'TOKEN_REUSE_DETECTED', 'ACCESS_DENIED');
...
-- CreateIndex
CREATE INDEX "AuthToken_purpose_idx" ON "AuthToken"("purpose");
